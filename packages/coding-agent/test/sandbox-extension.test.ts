...
// The sandbox extension has its own node_modules with @anthropic-ai/sandbox-runtime,
// so we must mock both resolution paths to ensure the extension uses our spy.
...
import sandboxExtension from "../examples/extensions/sandbox/index.js";
import type {
	ExtensionAPI,
	ExtensionContext,
	SessionStartEvent,
